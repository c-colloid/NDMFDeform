...
1. 変形したいレンダラー(SkinnedMeshRenderer など)の GameObject に **Deform Stack** を追加
2. 子 GameObject に **NDMF Deform > Deformers** から Lattice 等のデフォーマを追加し、
   Deform Stack の一覧に登録
3. NDMF プレビューで確認しながら編集 → アバタービルド時に自動でベイクされます
